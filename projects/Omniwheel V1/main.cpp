...
#include "../../KRAI_Library/MovingAverage/MovingAverage.h"             // Untuk MovAVG encoder
...
// Moving Average
MovingAverage moveAvgMotorFL(10);
MovingAverage moveAvgMotorFR(10);
MovingAverage moveAvgMotorBL(10);
MovingAverage moveAvgMotorBR(10);

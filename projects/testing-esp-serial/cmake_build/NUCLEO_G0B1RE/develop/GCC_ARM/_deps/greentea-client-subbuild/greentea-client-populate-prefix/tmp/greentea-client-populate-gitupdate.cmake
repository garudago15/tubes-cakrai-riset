...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/2. Programming and Project/URO-mbed-os/tubes-cakrai-riset/projects/testing-esp-serial/cmake_build/NUCLEO_G0B1RE/develop/GCC_ARM/_deps/greentea-client-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/2. Programming and Project/URO-mbed-os/tubes-cakrai-riset/projects/testing-esp-serial/cmake_build/NUCLEO_G0B1RE/develop/GCC_ARM/_deps/greentea-client-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
